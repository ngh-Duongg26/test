            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="blog" target="_blank">Trang chủ <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="blog-post" target="_blank">Giới thiệu về trường học</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" target="_blank">Đăng nhập</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="register" target="_blank">Đăng ký</a>
                    </li>
                </ul>
